  ...
  return (
    <div className="fixed bottom-5 right-3">
      <div className="block md:hidden">
        <a href="https://wa.me/6282312312123" target="_blank">
      ...
      <div className="hidden md:block">
        <a href="https://wa.me/6282312312123" target="_blank" className="select-none bg-primary-red py-2 px-6 text-white rounded-full flex items-center gap-3 cursor-pointer">
